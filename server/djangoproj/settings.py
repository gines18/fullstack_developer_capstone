...
ALLOWED_HOSTS = [
    ...
    'dealership.1h42d41hevw4.us-south.codeengine.appdomain.cloud'
    ]

CSRF_TRUSTED_ORIGINS = [
    'https://ruczkowskim-8000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai'
    ]
